          ...
          <div className="mobile-clean-grid">
            {displayedProducts.map((product) => (
              <article key={product.id} className="mobile-clean-card" onClick={() => router.push(`/market/${product.id}`)}>
                ...
                <img className={`${product.id}-market-image ${product.id === "dj-bag" ? "dj-bag-market-image" : product.id === "magma-ctrl-case-mc-707" ? "magma-case-market-image" : product.id === "hercules-inpulse-500" ? "hercules-market-image" : product.id === "flx10" ? "flx10-market-image" : product.id === "xdj-rr" ? "xdj-rr-market-image" : product.id === "ddj-sx2" ? "ddj-sx2-market-image" : product.id === "hdj-x5" ? "hdj-x5-market-image" : product.id === "jbl-live-770" ? "jbl-live-770-market-image" : ""}`} src={product.image} alt={product.name} />
                <div>
              ...
              {cartItems.length === 0 ? (
                ...
                cartItems.map((item) => (
                  <div className="market-cart-item" key={item.id}>
                    <img className={`${item.id}-market-image ${item.id}-cart-image ${item.id === "xdj-rr" ? "xdj-rr-cart-image" : item.id === "ddj-sx2" ? "ddj-sx2-cart-image" : item.id === "hdj-x5" ? "hdj-x5-cart-image" : item.id === "jbl-live-770" ? "jbl-live-770-cart-image" : ""}`} src={item.image} alt={item.name} onClick={() => router.push(`/market/${item.id}`)} style={{cursor:"pointer"}} />
                    <div>
