          ...
          <div className="mobile-clean-grid">
            {displayedProducts.map((product) => (
              <article key={product.id} className="mobile-clean-card" onClick={() => router.push(`/market/${product.id}`)}>
                ...
                <img className={product.id === "hercules-inpulse-500" ? "hercules-market-image" : product.id === "flx10" ? "flx10-market-image" : product.id === "xdj-rr" ? "xdj-rr-market-image" : ""} src={product.image} alt={product.name} />
                <div>
              ...
              >
                <FaHeart aria-hidden="true" />
                  ...
                  <img
                    ...
                    alt={product.name}
                    className={`product-real-image ${product.id === "ddj-800" ? "ddj800-market-image" : ""} ${product.id === "dj-bag" && djBagImages[djBagImage].includes("61oZrjkTLLL.jpg") ? "djbag-full-frame-image" : ""} ${product.id === "flx10" ? "flx10-market-image" : product.id === "ddj-sb3" ? "ddjsb3-market-image" : ""} ${product.id === "hercules-inpulse-500" ? "hercules-market-image" : ""} ${product.id === "xdj-rr" ? "xdj-rr-market-image" : ""}`} style={{ objectFit: "contain", width: "100%", height: "100%" }}
                  />
              ...
              {cartItems.length === 0 ? (
                ...
                cartItems.map((item) => (
                  <div className="market-cart-item" key={item.id}>
                    <img className={item.id === "xdj-rr" ? "xdj-rr-cart-image" : ""} src={item.image} alt={item.name} onClick={() => router.push(`/market/${item.id}`)} style={{cursor:"pointer", ...(item.id === "flx10" ? {transform:"scale(0.88)", transformOrigin:"center center"} : {})}} />
                    <div>
